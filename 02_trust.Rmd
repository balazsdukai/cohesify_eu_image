...
3. Count the number of responses per region per response (*1/2/3*) and compute the precentage of positive (*1*) responses per region. The answer *DK (3)* counts as negative response.
