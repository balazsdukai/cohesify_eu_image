...
eu_vars <- eu_vars %>% 
    mutate_at(c("trust_natgov", "trust_eu", "eqi_2013", "soc_idx",
                ...
                "eu_att_positive", "eu_att_neutral", "eu_att_negative", "eu_att_dk"),
              funs(. * weight))
...
Plus both dependent variables:

+ EU Identification
+ EU Attachment

*Please note that the sample outputs of the weighted variables in this report show their values **before** the weights were applied to them. Due to weighting, the values of these variables in the output files (see Ch.17) do not correspond any more to those that are shown in this report. However, the weights are easily removed by dividing the variable with the corresponding `weight` value.*
