...
NUTS3 has to be translated first, then merging them to NUTS2.
Do a spatial join of NUTS 2006 centroids to NUTS 2010 polygons, joining the *nuts id* from 2006, and that can be used later on to join the survey results to 2010.
