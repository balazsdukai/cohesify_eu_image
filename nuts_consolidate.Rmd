...
Slovenia *SI* only has NUTS0 level data.
...
qog_prep <- qog_raw_nuts0 %>% 
    full_join(qog_raw_nuts1, by = c("nuts_2006" = "id0.2006")) %>% 
...
The following countries have no NUTS2 level values:

```{r, results='asis', echo=FALSE}
knitr::kable(no_lvl2, caption = "Countries withouth NUTS2 values")
```
