...
qog_raw <- read.xlsx("~/Data/COHESIFY/Datasets for regression/QoG/publishing-the-eqi-data2013.xlsx", sheetName = "EQI2013", colIndex = c(1,9), startRow = 4, endRow = 251, header = TRUE)
```
