...
+ Some countries have not NUTS2 level data. There are 110 NUTS2 regions with originally missing values. In this cases higher level (NUTS0/1) values are inputed.
