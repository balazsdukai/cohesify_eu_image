...
fi1_avg <- mean(acc2soc_clean[acc2soc_clean$id2.2013 == "FI1D", "sgi_aggregated"])
acc2soc_clean[acc2soc_clean$id2.2013 == "FI1D", "sgi_aggregated"] <- fi1_avg
acc2soc_clean <-  distinct(acc2soc_clean)
```
...
+ Merge of *FI1A* + *FI13* = *FI1D*. The value for *FI1D* is the arithmetic average of *FI1A* (-0.93) and *FI13* (-1.18).
