...
+ Merge of *FI1A* + *FI13* = *FI1D*. The value for *FI1D* is the average of *FI1A* and *FI13* values, weighted with the number of NUTS3 regions within each NUTS2 region.

+ Merge of *DE41* + *DE42* = *DE40*. Boundary shift for *DED4* (2010) so it includes one NUTS3 region from *DED3* (2006). The value for both *DE40* and *DED4* is computed with the same process as in the previous step.
